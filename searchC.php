    ...
    <div class="container mt-3">
        ...
        <form action="" method="GET">
            ...
            <select name="country" id="country" class="btn btn-primary mx-2 mb-2">
                ...
                <?php
                    $sql = "SELECT DISTINCT Country from AirPollutionPM25";
        ...
        <tr>
            ...
            <?php 
                if(isset($_GET['submit'])){
                    ...
                    $sql = "SELECT sum(pm25) as sumPM25, year FROM AirPollutionPM25 WHERE Country = :country GROUP BY year ORDER BY year";
                    $query = $dbconn->prepare($sql);
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo round($res->sumPM25, 4); ?></td>        
                <?php } ?>
            <?php } ?>
    </table>
